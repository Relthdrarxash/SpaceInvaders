...
def affichagePlateauJeu(infos: Dict[str, int],
    ...
    Paramètre(s) : 
        ...
        @param atire : bool => Booléen indiquant si le vaisseau a tiré ou pas
    ...
    for y in range(infos["H"]):
        for x in range(infos["L"]):
            ...
            """if atire and x == vaisseau["posx"] and y == infos["H"] - 2:
                print("|")"""
...
if __name__ == '__main__':
    ...
    while not(partieFinie) and action != 'q':
        ...
        affichagePlateauJeu(plateau_jeu, lesAliens, leVaisseau, y_atteignable, aTire)
